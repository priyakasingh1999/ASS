...
const StationFiles = ({onClick}) => {
  return (
    <Box>
      <Box><InfoSubHead name={<Typography sx={{cursor:"pointer",border:"2px solid transparent",":hover":{border:"2px solid #1688ca"}}} onClick={onClick}>Station Files</Typography>} backgroundColor={"#d2dee8"} color={"#000"} /> </Box>
