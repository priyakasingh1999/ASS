...
const InfoHead = ({onClick,onClick2}) => {
          ...
          <Grid item xs={12}sx={{my:"auto",py:1}}>
           ...
           <Stack
            ...
            >
                ...
                <Avatar  sx={{width:{sm:"18px",xs:"10px",md:"15px"},height:{sm:"18px",xs:"10px",md:"15px"}, backgroundColor:"transparent"}}><ArrowDropDownIcon onClick={onClick} /></Avatar>
                </Tooltip>
                <Tooltip >

                <Avatar  sx={{width:{sm:"18px",xs:"10px"},height:{sm:"18px",xs:"10px"}, backgroundColor:"transparent"}}><ArrowDropDownIcon onClick={onClick2}/></Avatar>
                </Tooltip>
