...
const BrowserStation = ({setBrowserStation,browserstation}) => {
  return (
    <>
      <Box sx={{minWidth:"350px"}}>
        <Box>
            <InfoSubHead name="Browse Stations" urlname={<Typography onClick={()=>{setBrowserStation(false)}}>X</Typography>}  backgroundColor={"#1688ca"}
              color={"#fff"}/>
        </Box>
        <Box sx={{bgcolor:"#fff"}}>
