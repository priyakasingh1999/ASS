...
const TableBodyMsg = ({ name1, name2, name3, name4, name5, name6,name7,fontsize }) => {
  return (
    <Grid container>
      <Cusstyle/>
      <Grid item xs={12}>
        <Table style={{margin:0,border:"none"}}>
          <tbody>
            ...
            <td className="width_15" style={{textAlign:"center",fontSize: `${fontsize}`,verticalAlign:"middle" }}> {name7}</td>
              ...
              <td className="width_30" style={{textAlign:"center",fontSize: `${fontsize}`,verticalAlign:"middle" }}>{name3}</td>
