...
import MyFilesData from "../components/Main-Dashboard/Station/MyStation/MyFilesData";
    ...
    <div className="mb-2 staionFiles p-2">
      <Row className="mb-2">
        <Col md={12}>
          ...
          >
            <Tab eventKey="Add" title={<Typography variant="body2" color="initial">Add</Typography>}>
      ...
      <div style={{maxHeight:"300px",overflowY:"scroll"}}>
        {MyFilesData.map((SFData) => {
          const { id, img, title, time, filename, stationname,add } = SFData;
          return (
