...
function RecentSessions() {
  ...
  const [ses_id, setsess_id] = useState(null);
      ...
      <div className="session_box">
        <div className="recent_session_header d-flex align-items-center justify-content-between">
          <div className="left_session_icons d-flex align-items-center">
            <div className="priority_session pe-lg-3">
              <img
                src="img/dot-menu.png"
                className="global_icon_size cursor-pointer d-none d-sm-block"
                alt=""
                onClick={() => {
                  seticonaction(({ leaveactionmenu }) => {
          ...
          <Typography sx={{fontSize:{xs:"13px",md:"14px",lg:"16px"},fontWeight:"bold"}}>Recent Sessions</Typography>
          
          </div>
          <div className="recent_session_right_action">
            <div className="d-flex align-item-center" style={{ flexGrow: "1" }}>
              {/* <div className="add_new_session pe-3"></div> */}

              <div className="search_session  d-flex align-items-center">
                {showiconsubheader && (
                  <img
                    onClick={() =>
                      setsessionform({ ...sessionform, modalShow: true })
                    }
        ...
        <div class="session_Box pt-1 position-relative">
          {messageoption && (
            <Box
              width="35%"
              height="fit-content"
              sx={{
                backgroundColor: "#fff",
                boxShadow: " rgba(0, 0, 0, 0.35) 0px 5px 15px",p:1
              }}
            ...
            >
              ...
              <Stack direction="column">
                <FormControlLabel
                  ...
                  label={<Typography sx={{fontSize:"13px"}}>Show only Session Messaging</Typography>}
                  control={
                    <Checkbox
                    sx={{p:0}}
                      Checked
                ...
                <FormControlLabel
                  ...
                  label={<Typography sx={{fontSize:"13px"}}>Show icons on sub headers</Typography>}
                ...
                <FormControlLabel
                  ...
                  label={<Typography sx={{fontSize:"13px"}}>Add a Station</Typography>}
                ...
                <FormControlLabel
                  ...
                  label={<Typography sx={{fontSize:"13px"}}>Leave Actions Menu open</Typography>}
                ...
                <FormControlLabel
                  ...
                  label={<Typography sx={{fontSize:"13px"}}>Display Priority and Option Menu</Typography>}
            ...
            RecentSessionsData.map((sessionData) => {
              ...
              return (
                <div className="session_listing" key={id}>
                  <Row className="position-relative min_heigt">
                    <Col md={3} xs={10} className="d-flex gap-3 gap-md-0 d-md-block">
                      <div className="list_left_part d-flex align-items-center">
                        ...
                        <div>
                          <Typography sx={{fontSize:{xs:"14px",md:"14px",lg:"16px"},fontWeight:"bold"}}>{name}</Typography>
                          <Typography sx={{fontSize:{xs:"11px",md:"14px",lg:"16px"}}}>{formattedDate}</Typography>
                          
                        </div>
                      </div>

                      <ul className="session_action img-size ps-0 mb-0">
                        <li>
                          <a href="">
                            <img
                              src="img/Option.svg"
                    ...
                    <Col md={1} xs={2} className="small_padding">
                      <OverlayTrigger
                        delay={{ show: 250, hide: 300 }}
                        overlay={(props) => (
                          <Tooltip {...props} className="custom_tool_tip">
                    ...
                    <Col md={8}>
                      <div className="mb-10">
                        ...
                        <Typography sx={{fontSize:{xs:"14px",md:"15px"},my:{xs:1,sm:0}}}>{textbox}</Typography>
                      </div>

                      <div className="rs_comment_area">
                        <div className="comment_now">
                          <i className="fa fa-comments-o">
                            <span className="ps-2">{comments_count}</span>
                          </i>
                        </div>
                        <div>
                          <a
