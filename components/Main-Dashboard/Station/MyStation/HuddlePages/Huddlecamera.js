...
const Huddlecamera = ({ setVideo, setHuddledata, Huddledata }) => {
  ...
  return (
    <div className="video-huddle" >
      {videoStream && (
        <>
          <div className="video-screen bg-white">
            <video autoPlay ref={videoRef}  className="screen_width">
            ...
            <div className="videos-icon pt-2">
              <ul>
                {recording ? (
                  <li onClick={handleStopRecording}>
                    <PauseCircleFilledIcon />
                  </li>
                ) : (
                  <li onClick={handleStartRecording}>
                    <PlayCircleIcon />
                  </li>
                )}
                <li>
                  <CloudUploadIcon
                    onClick={() =>
                      setHuddledata({ ...Huddledata, VIDEO: videoblob })
                    }
                  />
                </li>
                <li>
