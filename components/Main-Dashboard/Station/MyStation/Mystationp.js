...
const MyStationp = ({ stationFile }) => {
  ...
  return (
    <div className="position-relative">
      ...
      <div className="Station-head sub-head py-2 fs-13 position-relative">
        {displayprority && (
          <div className="d-flex gap-2 ps-2">
            ...
            <div className="dropdown">
              ...
              {option && (
                <div className="dropdown-body text-lg-center">
        ...
        <div> 
          <ul>
            <li>
              {displayprority && (
                <img src="./img/MyStations.svg" onClick={widthadjust} />
              )}
            </li>
            <li>
      ...
      <div className="pb-2 bg-white stationss "  style={{ display: "flex"}}>
        {nstation &&
          nstation.map((sData) => {
            ...
            return (
              <Col key={_id} xs={width} >
                <div
                  onMouseEnter={() => {
                    setIsShown(stationname);
                    setshowid(id);
                  }}
                ...
                >
                            ...
                            >
                              <Stack spacing={0} direction="column">
                                ...
                                >
                                  ...
                                  <Link to="/discussion"><AddIcon /></Link>
                                </Box>
                                <Box
                                  sx={{
                                    display: "flex",
                  ...
                  <div className="station-img w-100 h-100 p-1">
                    <Card.Img
                      variant="top"
