    ...
    <div>
      <Stack direction="row" className="hstack gap-1">
        ...
        <div className="d-flex ">
          <button
            className="bg-light border  px-2 py-1 mt-1 me-2"
            onClick={(e) => {
              handlereplysubmit(e);
            }}
          >
          ...
          <button
            className="bg-light border  px-2 py-1 mt-1"
            onClick={() => setreplypage(0)}
          >
            Close
          </button>
        </div>
                  ...
                  return (
                    <>
                      {mdata.users && (
                        <Avatar
                          alt="Remy Sharp"
                          src={`https://assoc.studiomyraa.com/public/uploads/images/${mdata.users[0].image}`}
                        />
                      )}
