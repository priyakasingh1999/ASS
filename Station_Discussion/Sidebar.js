...
import {
  addcommentreply,
  getcommentbyreply,
} from "../Api/Discussion/Discussion";
      ...
      <Box sx={{ border: "4px solid #1688ca", padding: "3px" }}>
        ...
        <Stack direction="row" spacing={1}>
          {users && (
            <Avatar
              alt="Remy Sharp"
              src={`https://assoc.studiomyraa.com/public/uploads/images/${users[0].image}`}
            />
          )}
            ...
            return (
              <Stack direction="row" spacing={1} key={index}>
                ...
                <Stack direction="column">
                  <Typography variant="subtitle2">{redata.content}</Typography>
                  <Typography variant="subtitle2" sx={{ color: "#bbbbbd" }}>
                    {users && users[0].name}
                  </Typography>
                  <Typography
                    name={id}
